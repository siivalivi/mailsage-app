...
if ((!googleApiKeyFromEnv || googleApiKeyFromEnv.startsWith("YOUR_") || googleApiKeyFromEnv.startsWith("PASTE_")) && 
    (!geminiApiKeyFromEnv || geminiApiKeyFromEnv.startsWith("YOUR_") || geminiApiKeyFromEnv.startsWith("PASTE_"))) {
  const errorMsg =
    "CRITICAL GENKIT CONFIGURATION ERROR: The GOOGLE_API_KEY (or GEMINI_API_KEY) environment variable is not set or is a placeholder. " +
